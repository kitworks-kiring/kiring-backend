...
@OpenAPIDefinition(
        info = @Info(
                title = "Kiring API Documentation",
                version = "v1.0.1",
                description = "Kiring 프로젝트 API 명세서입니다.",
                contact = @Contact(
                        name = "Kiring팀",
                        email = "kiring.dev@gmail.com",
        ...
        servers = {
                @Server(url = "http://43.202.199.39", description = "Development Server"),
...
public class OpenApiConfig {
    ...
    public GroupedOpenApi adminApi() {
        return GroupedOpenApi.builder()
                ...
                // .addOpenApiCustomizer(...) // 더 세부적인 커스터마이징
                .build();
    }
    */
}
